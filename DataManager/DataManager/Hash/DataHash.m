...
- (NSData *)dataWithUTF8StringEncoding {
    const char *cstr = [self cStringUsingEncoding:NSUTF8StringEncoding];
    return [NSData dataWithBytes:cstr length:self.length];
}

- (NSString *)md5 {
    return [DataHash md5HashOfData:[self dataWithUTF8StringEncoding]];
}

- (NSString *)sha1 {
    return [DataHash sha1HashOfData:[self dataWithUTF8StringEncoding]];
}

- (NSString *)sha512 {
    return [DataHash sha512HashOfData:[self dataWithUTF8StringEncoding]];
}

- (NSString *)crc32 {
    return [DataHash crc32HashOfData:[self dataWithUTF8StringEncoding]];
}
