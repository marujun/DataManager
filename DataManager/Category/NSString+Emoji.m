...
//#warning - 字符串后面带着 \ufe0f 就会出问题 所以暂时不用下面的正则表达式
//    static dispatch_once_t onceToken;
//    static NSRegularExpression *regex = nil;
//    dispatch_once(&onceToken, ^{
//        regex = [[NSRegularExpression alloc] initWithPattern:@"(:[a-z0-9-+_]+:)" options:NSRegularExpressionUseUnicodeWordBoundaries error:NULL];
//    });
//    
//    __block NSString *resultText = self;
//    NSRange matchingRange = NSMakeRange(0, [resultText length]);
//    [regex enumerateMatchesInString:self options:NSMatchingReportCompletion range:matchingRange usingBlock:^(NSTextCheckingResult *result, NSMatchingFlags flags, BOOL *stop) {
